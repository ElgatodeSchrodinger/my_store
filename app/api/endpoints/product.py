...
def create_product(
    ...
    current_product: ProductDBSchema = Security(get_current_user_from_service, scopes=[UserRoles.admin.value])
    ) -> ProductDBSchema:
...
def get_product_by_id(
    ...
    product_service: ProductService = Depends(get_product_services), 
    token: str = Depends(AuthSchema),
    current_product: ProductDBSchema = Security(get_current_user_from_service, scopes=[UserRoles.admin.value, UserRoles.anonymous.value])
